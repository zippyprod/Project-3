...
//   let selectedPriceRange = document.getElementById('priceRangeSelect').value;
...
// document.getElementById('priceRangeSelect').addEventListener('change', filterMarkersByPrice);
